...
$cn= new coneccion();
        $sql = "select calificacion from historial where anio = 2001 and calificacion >= 70 ";
        $datos = mysql_query($sql, $cn->Conectarse());
        $aprobados = mysql_affected_rows();
        
        $cn->cerrarBd();
  $cn= new coneccion();
        $sql2 = "select calificacion from historial where anio = 2001 and calificacion < 70 ";
