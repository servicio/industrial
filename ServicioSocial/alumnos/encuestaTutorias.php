...
<html>
    ...
    <form name="cuestionario" action="guardarEncuesta.php">
        ...
        3.-&iquest;Que escolaridad tiene tu.. <br>
        3.1.-padre?<br>
        ...
        5.-&iquest;Cuantos hermanos son en tu familia incluy&eacute;ndote?<br>
        ...
        6.-&iquest;C&oacute;mo te llevas con tu<br>
        6.1 Padre ?<br>
        ...
        7.-&iquest;Qui&eacute;n sostiene econ&oacute;micamente tus estudios?<br>
        ...
        9.-&iquest;Qu&eacute; materias te gustan mas?<br>
        <input type="text" name="HabMaterias"> <br>



        10.-&iquest;Realizas otros estudios fuera de tecnol&oacute;gico?especifica<br>
        ...
        <br>
        12.-&iquest;Trabajas actualmente?<br>
        ...
        No <br>
        12.1.- &iquest;En que trabajas?<br>
        <input name="DondeTrabajas" type="text" disabled="disabled" >  <br>

        12.2.- &iquest;cual es el motivo por el cual laboras?<br>

        <input name="PorqTrab" type="text" disabled="disabled">  <br>
        12.3.- &iquest;Ocupacion en el trabajo?<br>
        <input name="OcupacionTrab" type="text" disabled="disabled">  <br>


        13.-&iquest;Cuales son las razones por la que ingrsaste al tecnol&oacute;gico?
        ...
        14.- &iquest;Cuales son las razones por la que ingresaste a la carrera?<br>
        ...
        15.- &iquest;Padece alguna alergia?<br>
        ...
        No         <br>
        &iquest;cual?  <input name="CualAlergia" type="text" disabled="disabled"> </label> <br>



        16.- &iquest;Padece alguna enfermedad cr&oacute;nica? <br>
        ...
        No         <br>
        &iquest;Cuál?  <input name="CronicaCual" type="text" disabled="disabled">  <br>



        17.- &iquest;Has recibido atenci&oacute;n psicol&oacute;gica? 
        ...
        18.-&iquest;Donde recibes atenci&oacute;n medica?<br>
        ...
        20.-&iquest;Consumes bebidas embriagantes?
        ...
        21.-&iquest;Has tenido problemas legales? 
        ...
        22.- &iquest;Practicas algun deporte?
        ...
        &iquest;Conque frecuencia lo realizas?<input name="FrecuenciaDept" type="text" disabled="disabled"> <br>
