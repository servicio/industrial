...
<html>
    ...
    <form name="cuestionario" action="guardarEncuesta.php">
        ...
        Si
        ¿cu&aacute;l?<input name="CualAlergia" type="text" disabled="disabled">
        ...
        23.- &iquest;Practicas al&uacute;n deporte?
        ...
        No <br>
        23.1.- &iquest;Cu&aacute;l? <input name="CualDep" type="text" disabled="disabled">  <br>
        23.2.- &iquest;Con que frecuencia lo realizas?<input name="FrecuenciaDept" type="text" disabled="disabled"> <br>
